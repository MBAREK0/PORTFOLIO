<template>
    <section id="honors-and-awards" class="mb-5 section">
        ...
        <p class="text-sm ">I have received several awards and honors for my work in the tech industry. Here are some of
            the
            awards I have received.</p>
        <div class="grid grid-cols-1 gap-4 mt-4 xl:grid-cols-2 w-full" v-if="HonorsAndAwardsStore.loading">
        ...
        <div class="grid grid-cols-1 gap-4 mt-4 xl:grid-cols-2 w-full" v-else>
                ...
                <div class="flex flex-col md:flex-row items-start  md:items-center gap-2 md;gap-0 justify-between mb-3">
                    <div class="flex items-center justify-start gap-2">
                        <img :src="mainStore.baseUrl + 'images/awards/' + award.imageName" alt="Image"
                            class="mt-2 w-10 h-10 " v-if="award.imageName">
                        <div class="flex flex-col items-start justify-start ">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100">{{ award.title }}</h3>
