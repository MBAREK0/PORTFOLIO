<template>
    <section id="contact-me" class="mb-5 section">
        ...
        <p class="text-sm">
            I am available for freelance work. If you have a project that you want to get started, think you need my
        ...
        <form class="mt-5" @submit.prevent="sendEmail">
            ...
            <div class="mb-4 ">
                <label for="email-address-icon" class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Your
                    Email</label>
                <div class="relative">
