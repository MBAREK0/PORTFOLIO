<template>
           ...
           <div class="mt-6">
            ...
            <div role="status" class="space-y-2.5 animate-pulse max-w-lg " v-if="languagesStore.loading">
            ...
            <div class="flex flex-wrap gap-2" v-else>
                <div class="flex items-center" v-for="language in languages " :key="language.id">
                    <span
                        class="text-xs font-semibold px-2 py-0.5 text-blue-800 bg-blue-100 dark:bg-blue-200 dark:text-blue-800 rounded-l">{{ language.name }}</span>
                    <span
                        class="text-xs font-semibold px-2 py-0.5 text-white bg-gray-500 dark:bg-gray-300 dark:text-blue-800 rounded-r">{{ language.proficiency }}</span>
                </div>
